...
import { Attractions, Avatar, Unknown, Hotels, NotFound, Restaurants } from '../../assets';
  ...
  return (
    <SafeAreaView className="flex-1 bg-white relative mt-10">
      <View className="flex-row items-center justify-between px-8">
        ...
        <View className="w-12 h-12 bg-gray-400 rounded-md items-center shadow-lg">
            <Image source={Unknown} className="w-full h-full rounded-md object-cover" />
        </View>
      </View>
            ...
            <View>
                <View className="flex-row items-center justify-between px-4 mt-6">
                    ...
                    <TouchableOpacity className="flex-row items-center justify-center space-x-2">
                        ...
                        <ArrowRightIcon size={24} color="#A0C4C7"/>
                    </TouchableOpacity>
                </View>
                <View className="px-0 mt-2 flex-row items-center justify-evenly flex-wrap">
                    {mainData?.length > 0 ? (
                    <>
                        {mainData?.map((data, i) => (
                            <ItemCardContainer 
